        ...
        <div className="w-full max-w-md">
          ...
          <div className="editorial-card p-8">
            <div className="text-center mb-8">
              <p className="font-meta text-[#1e40af] mb-2">Welcome Back</p>
              <h1 className="font-display text-2xl text-stone-900">Log in to continue</h1>
              <p className="text-stone-500 mt-2">Your adventures await</p>
            </div>
            <LoginForm />
          </div>
        </div>
