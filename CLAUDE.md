...
Configure automatic backup after every commit:

```bash
# Create git hook for auto-push (recommended)
...
│   │   │   ├── models/    # Data models (Trip, Event, Expense)
...
### 🎯 Quick Start
1. **Read this file first** - Contains essential rules for Claude Code
